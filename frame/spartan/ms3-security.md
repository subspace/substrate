...
![c-correlation.png](c-correlation.png)

As the slot update interval (epoch) is increased, the security threshold increases from 27% to 50%. At an epoch duration of 32 blocks (3 mins), the security is up to 42%. At an epoch duration of 256 blocks (26 mins), the security is up to 47%)
